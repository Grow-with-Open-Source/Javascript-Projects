...
> [!IMPORTANT]
> Make sure to check the [CONTRIBUTING.md](CONTRIBUTING.md "goto CONTRIBUTING.md") to understand the rules, file structure and step-by-step guide for contribution.
